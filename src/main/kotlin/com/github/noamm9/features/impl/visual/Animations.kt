...
object Animations: Feature("Allows you to modify your hand viewmodel") {
    ...
    val mainHandX by SliderSetting("X", 0, - 2, 2, 0.05)
    val mainHandY by SliderSetting("Y", 0, - 2, 2, 0.05)
    val mainHandZ by SliderSetting("Z", 0, - 2, 2, 0.05)
    ...
    val swingX by SliderSetting("swingX", 1, 0.1, 2)
    val swingY by SliderSetting("swingY", 1, 0.1, 2)
    val swingZ by SliderSetting("swingZ", 1, 0.1, 2)
